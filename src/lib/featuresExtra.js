...
.card{position:relative;background:var(--card);border:1px solid var(--line);border-radius:28px;box-shadow:0 28px 90px rgba(15,23,42,.16);padding:2rem;overflow:hidden;backdrop-filter:blur(18px);text-align:left}
...
input{width:100%;padding:1rem 1rem 1rem 3.6rem;border:1px solid rgba(148,163,184,.42);border-radius:16px;background:#fff;color:#0f172a;font-size:1.05rem;text-align:center;letter-spacing:.24em;box-shadow:inset 0 1px 0 rgba(15,23,42,.04);transition:border-color .18s,box-shadow .18s,background .18s}
input::placeholder{color:rgba(71,85,105,.58);letter-spacing:.05em}
input:focus{outline:none;border-color:rgba(34,211,238,.88);box-shadow:0 0 0 4px rgba(6,182,212,.16);background:#fff}
